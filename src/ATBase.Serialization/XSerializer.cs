...
namespace ATBase.Serialization
{
    ...
    public class XSerializer
    {
        ...
        public T Deserialize<T>(String xml)
        {
            ...
            var custTypeXElementAttr = targetType.GetCustomAttribute<XSelectAttribute>();
            if (custTypeXElementAttr != null)
            {
                root = root.XPathSelectElement(custTypeXElementAttr.XPath);
            }
